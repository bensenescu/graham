/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 220059779e0582512f8f2522fa34d128)
// Runtime types generated with workerd@1.20260116.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "SimpleCollabDO" | "PageCollabDO";
	}
	interface Env {
		KV: KVNamespace;
		VITE_APP_ID: string;
		...
		SIMPLE_COLLAB_DO: DurableObjectNamespace<import("./src/server").SimpleCollabDO>;
		PAGE_COLLAB_DO: DurableObjectNamespace<import("./src/server").PageCollabDO>;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_APP_ID" | "VITE_GATEWAY_URL" | "GATEWAY_URL" | "OPENAI_API_KEY">> {}
}
